public class Start{
    ...
    public String Start1(){
  		...
  		if(start==0){
  			...
  			System.out.println("After staring for a bit you can finally see, you choose to look around.");
  		}
  		else if(start==1){
  			...
  			System.out.println("You decide to go look around.");
  		}
  		else{
  		...
  		System.out.println("The goal of this game is to make a parachute with items you find and jump off the roof with it.");
   		return Start1;
   	}
}
